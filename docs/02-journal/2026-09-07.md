...
# Journal du Lundi 7 Septembre 2026 rédigé par(Lucas KPEGAN)
-Echange sur divers sujets notamment: l'aspect financier lié à la formation, au processus de notation des documentations du projet final, et à la certification
-Téléchargement et Installation de Kicad
-Questionnaires sur ce que c'est qu'un circuit PCB ?
-Echanges sur le concept de FabLab, de l'Open Source

Début du cours d'iniatiation aux PCB: De l'idée au circuit imprimé dirigé par Arnauld Kpadenou
comprendre le rôle d'un PCB, ses couches, la conception, le routage, la fabrication et les tests
...
Pourquoi passer du prototypage au PCB ?
breadboard
idéale pour tester rapidement une idée
...
pcb
solution permanente, compacte et fiable
 - réduction taille et cablage
 - connexions solides et répétables
 - meilleure résistance aux vibrations
 - fabrication en plusieurs exemplaires


Anatomie d'un PCB
7 éléments clés qui entrent dans la composition d'un PCB
- substrat
- cuivre
- solder mask
- silkscreen
...
De l'idée au schéma
confère image
exo de maison: recherche sur les composants éléctriques et leurs symboles

Partie pratique:
ouverture de kiCad et choix-de-l'environnement-kikad-pour-la-creation-d'un-circuit 
création du dossier PCB101 sur le bureau et ouverture du dossier PCB101 dans KiCad
Prise en main de Kicad et début des importations des composants matériels utiles à notre projet:
Deux résistances; une photo-résistance; un transistor, une LED, une borne posistive fléchéé +5V et une borne négative GND appelée masse
Disposition des matériels sur la feuille technique et début des connexions avec l'outil liaison
Attribution d'une valeur de 220V à notre 2ème , et une valeur de 1micro-ohm pour la deuxième
contrôle des règles electriques, et execution du bouton ERC, deux erreurs sont survenus
ensuite j'ai résolu les deux erreurs en fesant venir une battery-cell pour alimenter le circuit

Nous sommes ensuite partis dans l'onlet enregister empreinte, nous avons choisi les caractéristiques des différents composantes éléctriques de notre circuit éléctrique, après nous avons enregistré et continuer nous avons ensuite cliquer sur l'onglet PCB et notre dessin est arrivé sur une nouvelle feuille technique, nous avons redisposer correctement nos composants et nous avons fait une bordure de tout le circuit après quoi nous avons fait le routage, après je sui  parti en mode 3D avec la commande ALT + 3
